...
import com.l2j.gameserver.cache.InfoCache;
...
import com.l2j.gameserver.model.L2MinionData;
			...
			else
			{
				...
				switch(id)
				{
					...
					{//Division
						...
						if(Config.DIVISION_POWER_MULTIPLIER > 0)
						{
							multi_value = multi_value * Config.DIVISION_POWER_MULTIPLIER;
						}
