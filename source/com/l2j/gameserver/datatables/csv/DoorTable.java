 ...
 */
package com.l2j.gameserver.datatables.csv;
...
public class DoorTable
{
	...
	public void checkAutoOpen()
	{
		...
		/*
		//Pvp zone doors
			else if(doorInst.getDoorName().startsWith("Gate_of_Errors"))
			{
				doorInst.setAutoActionDelay(600);
			}
		//pvp zone doors
			else if(doorInst.getDoorName().startsWith("Mausoleum_Gate"))
			{
				doorInst.setAutoActionDelay(600);
			}
			*/
	...
	//Custom Doors
	public void CustomDoorsOpen()
	{
		//Try to call Doors xD
		for(L2DoorInstance CustomDoorInst : getDoors())
			//PvP Area Doors
		if(CustomDoorInst.getDoorName().startsWith("Mausoleum_Gate"))
		{
			CustomDoorInst.openMe();
		}
		else if(CustomDoorInst.getDoorName().startsWith("Gate_of_Errors"))
		{
			CustomDoorInst.openMe();
		}
	}
