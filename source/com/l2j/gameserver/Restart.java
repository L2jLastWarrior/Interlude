 /*
    ...
    public class Restart
    {
          ...
          //:D
            ...
            {
                _log.info("AutoRestartSystem:System Actived");
                    try
                    {
                            ...
                            _log.info("AutoRestartSystem: Next Restart Time: " + NextRestart.getTime().toString());
                ThreadPoolManager.getInstance().scheduleGeneral(new StartRestartTask(), flush2);
                    }
                    catch (Exception e)
                    {
                            System.out.println("AutoRestartSystem: The restart automated server presented error in load restarts period config !");
                    }
            }
            ...
            class StartRestartTask implements Runnable
            {
                    public void run()
                    {
               _log.info("AutoRestartSystem Started...!");
