...
import com.l2j.gameserver.model.zone.L2ZoneManager;
...
import com.l2j.util.object.L2ObjectSet;
			...
			for(L2Object o : _visibleObjects)
			{
				if(o instanceof L2Attackable)
				{
					...
					if(mob.getAI()!=null){
						...
						mob.getAI().setIntention(com.l2j.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE);
