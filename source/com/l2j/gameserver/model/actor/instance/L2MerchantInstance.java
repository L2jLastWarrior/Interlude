...
import com.l2j.gameserver.model.L2TradeList;
...
import com.l2j.gameserver.network.serverpackets.BuyList;
...
import com.l2j.gameserver.network.serverpackets.SellList;
import com.l2j.gameserver.network.serverpackets.StatusUpdate;
import com.l2j.gameserver.network.serverpackets.WearList;
...
public class L2MerchantInstance extends L2FolkInstance
{
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.actor.instance.L2NpcInstance#onActionShift(com.l2j.gameserver.network.L2GameClient)
	 */
	@Override
