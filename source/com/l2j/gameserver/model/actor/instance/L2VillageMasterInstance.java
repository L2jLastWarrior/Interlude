...
import com.l2j.gameserver.model.L2Clan.SubPledge;
...
import com.l2j.gameserver.model.base.PlayerRace;
...
import com.l2j.gameserver.network.serverpackets.AquireSkillList;
...
public final class L2VillageMasterInstance extends L2FolkInstance
{
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.actor.instance.L2FolkInstance#onBypassFeedback(com.l2j.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.actor.instance.L2NpcInstance#getHtmlPath(int, int)
	 */
	@Override
		...
		if(availSubs != null)
		{
			for(PlayerClass availSub : availSubs)
			{
				...
				else if(Config.WORLD_MASTER)
				{
					/*
					 * Nothing happen
					 * Every class can take all class
					 */
				}
			}
		}
