...
import static com.l2j.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
...
import com.l2j.gameserver.datatables.MobGroupTable;
...
import com.l2j.gameserver.managers.CustomNpcInstanceManager;
...
import com.l2j.gameserver.model.L2DropCategory;
import com.l2j.gameserver.model.L2DropData;
...
import com.l2j.gameserver.model.actor.knownlist.NpcKnownList;
import com.l2j.gameserver.model.actor.stat.NpcStat;
import com.l2j.gameserver.model.actor.status.NpcStatus;
...
import com.l2j.gameserver.model.entity.event.Lottery;
...
import com.l2j.gameserver.model.scripts.L2RBManager;
...
import com.l2j.gameserver.network.serverpackets.ExShowVariationCancelWindow;
import com.l2j.gameserver.network.serverpackets.ExShowVariationMakeWindow;
...
import com.l2j.gameserver.network.serverpackets.RadarControl;
...
public class L2NpcInstance extends L2Character
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Object#isAttackable()
	 */
	@Override
	...
	public void onActionShift(L2GameClient client)
	{
		...
		else if (Config.ALT_GAME_VIEWNPC)
		{
			...
			html1.append("Rates legend: <font color=\"00FF00\">100%+</font> <font color=\"0066CC\">50%+</font> <font color=\"000099\">30+%</font> <font color=\"FF9900\">15+%</font> <font color=\"FF66FF\">1+%</font> <font color=\"FF0000\">-1</font>");
			html1.append("<table border=0 width=\"100%\">");
