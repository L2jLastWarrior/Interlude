...
import static com.l2j.gameserver.ai.CtrlIntention.AI_INTENTION_MOVE_TO;
...
import com.l2j.gameserver.ai.L2CharacterAI;
import com.l2j.gameserver.ai.L2PlayerAI;
import com.l2j.gameserver.cache.HtmCache;
import com.l2j.gameserver.cache.WarehouseCacheManager;
import com.l2j.gameserver.communitybbs.BB.Forum;
...
import com.l2j.gameserver.datatables.AccessLevel;
...
import com.l2j.gameserver.handler.admincommandhandlers.AdminEditChar;
import com.l2j.gameserver.handler.skillhandlers.SiegeFlag;
import com.l2j.gameserver.handler.skillhandlers.StrSiegeAssault;
import com.l2j.gameserver.handler.skillhandlers.TakeCastle;
...
import com.l2j.gameserver.managers.TownManager;
import com.l2j.gameserver.model.BlockList;
import com.l2j.gameserver.model.FishData;
import com.l2j.gameserver.model.Inventory;
import com.l2j.gameserver.model.ItemContainer;
import com.l2j.gameserver.model.L2Attackable;
import com.l2j.gameserver.model.L2Character;
import com.l2j.gameserver.model.L2Clan;
import com.l2j.gameserver.model.L2ClanMember;
import com.l2j.gameserver.model.L2Effect;
import com.l2j.gameserver.model.L2Fishing;
import com.l2j.gameserver.model.L2Macro;
import com.l2j.gameserver.model.L2ManufactureList;
import com.l2j.gameserver.model.L2Object;
import com.l2j.gameserver.model.L2Party;
import com.l2j.gameserver.model.L2Radar;
import com.l2j.gameserver.model.L2RecipeList;
import com.l2j.gameserver.model.L2Request;
import com.l2j.gameserver.model.L2ShortCut;
import com.l2j.gameserver.model.L2Skill;
import com.l2j.gameserver.model.L2Skill.SkillTargetType;
import com.l2j.gameserver.model.L2Skill.SkillType;
import com.l2j.gameserver.model.L2SkillLearn;
import com.l2j.gameserver.model.L2Summon;
import com.l2j.gameserver.model.L2World;
import com.l2j.gameserver.model.Location;
import com.l2j.gameserver.model.MacroList;
import com.l2j.gameserver.model.PartyMatchRoom;
import com.l2j.gameserver.model.PartyMatchRoomList;
import com.l2j.gameserver.model.PartyMatchWaitingList;
import com.l2j.gameserver.model.PcFreight;
import com.l2j.gameserver.model.PcInventory;
import com.l2j.gameserver.model.PcWarehouse;
import com.l2j.gameserver.model.PetInventory;
import com.l2j.gameserver.model.PlayerStatus;
import com.l2j.gameserver.model.ShortCuts;
import com.l2j.gameserver.model.TradeList;
import com.l2j.gameserver.model.actor.appearance.PcAppearance;
import com.l2j.gameserver.model.actor.knownlist.PcKnownList;
import com.l2j.gameserver.model.actor.position.L2CharPosition;
import com.l2j.gameserver.model.actor.stat.PcStat;
import com.l2j.gameserver.model.actor.status.PcStatus;
import com.l2j.gameserver.model.base.ClassId;
import com.l2j.gameserver.model.base.ClassLevel;
import com.l2j.gameserver.model.base.PlayerClass;
import com.l2j.gameserver.model.base.Race;
import com.l2j.gameserver.model.base.SubClass;
import com.l2j.gameserver.model.entity.Announcements;
import com.l2j.gameserver.model.entity.Duel;
import com.l2j.gameserver.model.entity.L2Rebirth;
import com.l2j.gameserver.model.entity.event.CTF;
import com.l2j.gameserver.model.entity.event.DM;
import com.l2j.gameserver.model.entity.event.L2Event;
import com.l2j.gameserver.model.entity.event.TvT;
import com.l2j.gameserver.model.entity.event.VIP;
...
import com.l2j.gameserver.model.entity.siege.FortSiege;
...
import com.l2j.gameserver.model.zone.type.L2TownZone;
...
import com.l2j.gameserver.network.serverpackets.ChangeWaitType;
import com.l2j.gameserver.network.serverpackets.CharInfo;
import com.l2j.gameserver.network.serverpackets.ConfirmDlg;
...
import com.l2j.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import com.l2j.gameserver.network.serverpackets.ExFishingEnd;
import com.l2j.gameserver.network.serverpackets.ExFishingStart;
import com.l2j.gameserver.network.serverpackets.ExOlympiadMode;
import com.l2j.gameserver.network.serverpackets.ExOlympiadUserInfo;
import com.l2j.gameserver.network.serverpackets.ExPCCafePointInfo;
import com.l2j.gameserver.network.serverpackets.ExSetCompassZoneCode;
...
import com.l2j.gameserver.network.serverpackets.LeaveWorld;
import com.l2j.gameserver.network.serverpackets.MagicSkillCanceld;
...
import com.l2j.gameserver.network.serverpackets.NpcInfo;
import com.l2j.gameserver.network.serverpackets.ObservationMode;
import com.l2j.gameserver.network.serverpackets.ObservationReturn;
import com.l2j.gameserver.network.serverpackets.PartySmallWindowUpdate;
import com.l2j.gameserver.network.serverpackets.PetInventoryUpdate;
import com.l2j.gameserver.network.serverpackets.PlaySound;
import com.l2j.gameserver.network.serverpackets.PledgeShowInfoUpdate;
import com.l2j.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import com.l2j.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import com.l2j.gameserver.network.serverpackets.PrivateStoreListBuy;
import com.l2j.gameserver.network.serverpackets.PrivateStoreListSell;
import com.l2j.gameserver.network.serverpackets.QuestList;
import com.l2j.gameserver.network.serverpackets.RecipeShopSellList;
import com.l2j.gameserver.network.serverpackets.RelationChanged;
import com.l2j.gameserver.network.serverpackets.Ride;
import com.l2j.gameserver.network.serverpackets.SendTradeDone;
import com.l2j.gameserver.network.serverpackets.SetupGauge;
import com.l2j.gameserver.network.serverpackets.ShortBuffStatusUpdate;
import com.l2j.gameserver.network.serverpackets.ShortCutInit;
import com.l2j.gameserver.network.serverpackets.SkillCoolTime;
import com.l2j.gameserver.network.serverpackets.SkillList;
import com.l2j.gameserver.network.serverpackets.Snoop;
import com.l2j.gameserver.network.serverpackets.SocialAction;
import com.l2j.gameserver.network.serverpackets.StatusUpdate;
import com.l2j.gameserver.network.serverpackets.StopMove;
import com.l2j.gameserver.network.serverpackets.SystemMessage;
import com.l2j.gameserver.network.serverpackets.TargetSelected;
import com.l2j.gameserver.network.serverpackets.TitleUpdate;
import com.l2j.gameserver.network.serverpackets.TradePressOtherOk;
import com.l2j.gameserver.network.serverpackets.TradePressOwnOk;
import com.l2j.gameserver.network.serverpackets.TradeStart;
import com.l2j.gameserver.network.serverpackets.TutorialShowHtml;
import com.l2j.gameserver.network.serverpackets.UserInfo;
import com.l2j.gameserver.network.serverpackets.ValidateLocation;
import com.l2j.gameserver.skills.Formulas;
import com.l2j.gameserver.skills.Stats;
import com.l2j.gameserver.skills.effects.EffectCharge;
import com.l2j.gameserver.skills.l2skills.L2SkillSummon;
import com.l2j.gameserver.templates.L2Armor;
import com.l2j.gameserver.templates.L2ArmorType;
import com.l2j.gameserver.templates.L2EtcItemType;
import com.l2j.gameserver.templates.L2Henna;
import com.l2j.gameserver.templates.L2Item;
import com.l2j.gameserver.templates.L2PcTemplate;
import com.l2j.gameserver.templates.L2Weapon;
...
public final class L2PcInstance extends L2PlayableInstance
{
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		/*
		 * (non-Javadoc)
		 * @see com.l2j.gameserver.model.L2Character.AIAccessor#doAttack(com.l2j.gameserver.model.L2Character)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see com.l2j.gameserver.model.L2Character.AIAccessor#doCast(com.l2j.gameserver.model.L2Skill)
		 */
		@Override
...
private int _reviveRequested = 0;
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.actor.instance.L2PlayableInstance#getKnownList()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.actor.instance.L2PlayableInstance#getStat()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.actor.instance.L2PlayableInstance#getStatus()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#updatePvPFlag(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#revalidateZone(boolean)
	 */
	@Override
...
//		}
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Object#onActionShift(com.l2j.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.actor.instance.L2PlayableInstance#isInFunEvent()
	 */
	@Override
...
//	}
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#getLevelMod()
	 */
	@Override
	...
	*/
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#toString()
	 */
	@Override
...
*/
	...
	*/
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#doRevive()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#doRevive(double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#onTeleported()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#updatePosition(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#addExpAndSp(long, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#reduceCurrentHp(double, com.l2j.gameserver.model.L2Character)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#reduceCurrentHp(double, com.l2j.gameserver.model.L2Character, boolean)
	 */
	@Override
	...
	*/
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Character#sendDamageMessage(com.l2j.gameserver.model.L2Character, int, boolean, boolean, boolean)
	 */
	@Override
