...
import static com.l2j.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
import static com.l2j.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
...
import com.l2j.gameserver.ai.CtrlEvent;
import com.l2j.gameserver.ai.CtrlIntention;
import com.l2j.gameserver.ai.L2AttackableAI;
...
import com.l2j.gameserver.datatables.csv.MapRegionTable.TeleportWhereType;
import com.l2j.gameserver.datatables.sql.NpcTable;
import com.l2j.gameserver.geo.GeoData;
import com.l2j.gameserver.geo.pathfinding.Node;
import com.l2j.gameserver.geo.pathfinding.PathFinding;
import com.l2j.gameserver.handler.ISkillHandler;
import com.l2j.gameserver.handler.SkillHandler;
import com.l2j.gameserver.handler.itemhandlers.Potions;
...
import com.l2j.gameserver.model.actor.instance.L2BoatInstance;
import com.l2j.gameserver.model.actor.instance.L2ControlTowerInstance;
import com.l2j.gameserver.model.actor.instance.L2DoorInstance;
import com.l2j.gameserver.model.actor.instance.L2EffectPointInstance;
import com.l2j.gameserver.model.actor.instance.L2GrandBossInstance;
import com.l2j.gameserver.model.actor.instance.L2GuardInstance;
import com.l2j.gameserver.model.actor.instance.L2ItemInstance;
import com.l2j.gameserver.model.actor.instance.L2MinionInstance;
...
import com.l2j.gameserver.model.actor.instance.L2NpcWalkerInstance;
import com.l2j.gameserver.model.actor.instance.L2PcInstance;
import com.l2j.gameserver.model.actor.instance.L2PcInstance.SkillDat;
import com.l2j.gameserver.model.actor.instance.L2PetInstance;
import com.l2j.gameserver.model.actor.instance.L2PlayableInstance;
import com.l2j.gameserver.model.actor.instance.L2RaidBossInstance;
import com.l2j.gameserver.model.actor.instance.L2RiftInvaderInstance;
import com.l2j.gameserver.model.actor.instance.L2SiegeFlagInstance;
import com.l2j.gameserver.model.actor.instance.L2SummonInstance;
import com.l2j.gameserver.model.actor.knownlist.CharKnownList;
import com.l2j.gameserver.model.actor.knownlist.ObjectKnownList.KnownListAsynchronousUpdateTask;
...
import com.l2j.gameserver.model.actor.stat.CharStat;
import com.l2j.gameserver.model.actor.status.CharStatus;
...
import com.l2j.gameserver.model.zone.type.L2BossZone;
...
import com.l2j.gameserver.network.serverpackets.Attack;
import com.l2j.gameserver.network.serverpackets.BeginRotation;
import com.l2j.gameserver.network.serverpackets.ChangeMoveType;
import com.l2j.gameserver.network.serverpackets.ChangeWaitType;
import com.l2j.gameserver.network.serverpackets.CharInfo;
import com.l2j.gameserver.network.serverpackets.CharMoveToLocation;
import com.l2j.gameserver.network.serverpackets.ExOlympiadSpelledInfo;
...
import com.l2j.gameserver.network.serverpackets.MagicEffectIcons;
import com.l2j.gameserver.network.serverpackets.MagicSkillCanceld;
import com.l2j.gameserver.network.serverpackets.MagicSkillLaunched;
...
import com.l2j.gameserver.network.serverpackets.PartySpelled;
import com.l2j.gameserver.network.serverpackets.PetInfo;
import com.l2j.gameserver.network.serverpackets.RelationChanged;
import com.l2j.gameserver.network.serverpackets.Revive;
...
import com.l2j.gameserver.network.serverpackets.TargetUnselected;
import com.l2j.gameserver.network.serverpackets.TeleportToLocation;
import com.l2j.gameserver.network.serverpackets.ValidateLocation;
import com.l2j.gameserver.network.serverpackets.ValidateLocationInVehicle;
import com.l2j.gameserver.skills.Calculator;
...
import com.l2j.gameserver.skills.funcs.Func;
import com.l2j.gameserver.skills.holders.ISkillsHolder;
import com.l2j.gameserver.templates.L2CharTemplate;
...
import com.l2j.gameserver.templates.StatsSet;
...
public abstract class L2Character extends L2Object implements ISkillsHolder
{
	...
	/** Flag Pvp Zone */
	public static final int ZONE_FLAG_PVP = 0;
...
*/
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Object#onSpawn()
	 */
	@Override
	public void onSpawn()
	{
...
*/
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Object#getKnownList()
	 */
	@Override
	 ...
	 * <BR>
	 * see com.l2j.gameserver.model.L2Character
	 */
...
//					removeStatFuncs(skill_funcs);
	...
	*/
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.model.L2Object#toString()
	 */
	@Override
