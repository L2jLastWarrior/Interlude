...
import com.l2j.gameserver.ai.L2SummonAI;
...
import com.l2j.gameserver.model.actor.instance.L2SiegeSummonInstance;
import com.l2j.gameserver.model.actor.knownlist.SummonKnownList;
import com.l2j.gameserver.model.actor.stat.SummonStat;
import com.l2j.gameserver.model.actor.status.SummonStatus;
...
import com.l2j.gameserver.network.serverpackets.PetDelete;
import com.l2j.gameserver.network.serverpackets.PetStatusShow;
import com.l2j.gameserver.network.serverpackets.PetStatusUpdate;
...
public abstract class L2Summon extends L2PlayableInstance
{
	 ...
	 * @see com.l2j.gameserver.model.L2Character#doCast(com.l2j.gameserver.model.L2Skill)
	 */
	@Override
