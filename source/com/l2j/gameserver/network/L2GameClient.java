 ...
 */
package com.l2j.gameserver.network;
...
import com.l2j.gameserver.model.CharSelectInfoPackage;
...
import com.l2j.gameserver.network.serverpackets.ServerClose;
import com.l2j.gameserver.thread.LoginServerThread;
import com.l2j.gameserver.thread.LoginServerThread.SessionKey;
import com.l2j.gameserver.thread.ThreadPoolManager;
import com.l2j.gameserver.util.EventData;
import com.l2j.gameserver.util.FloodProtectors;
import com.l2j.logs.Log;
import com.l2j.netcore.MMOClient;
import com.l2j.netcore.MMOConnection;
import com.l2j.netcore.ReceivablePacket;
...
public final class L2GameClient extends MMOClient<MMOConnection<L2GameClient>> implements Runnable
{
	...
	public L2GameClient(MMOConnection<L2GameClient> con)
	{
		...
		_packetQueue = new ArrayBlockingQueue<ReceivablePacket<L2GameClient>>(com.l2j.netcore.Config.getInstance().CLIENT_PACKET_QUEUE_SIZE);
