...
import com.l2j.gameserver.util.IllegalPlayerAction;
...
public class MoveBackwardToLocation extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		else
		{
			...
			if(Config.CAN_JUMP)
			{
				PlayerJump(activeChar,_targetX, _targetY, _targetZ);
			}
			*/
	...
	/*	
	public void PlayerJump(L2PcInstance activeChar,int x,int y, int z)
	{
