...
import com.l2j.gameserver.managers.PacketsLoggerManager;
import com.l2j.gameserver.network.L2GameClient.GameClientState;
import com.l2j.gameserver.network.clientpackets.*;
import com.l2j.gameserver.network.serverpackets.ActionFailed;
import com.l2j.logs.Log;
import com.l2j.netcore.IClientFactory;
import com.l2j.netcore.IMMOExecutor;
import com.l2j.netcore.IPacketHandler;
import com.l2j.netcore.MMOConnection;
import com.l2j.netcore.ReceivablePacket;
import com.l2j.util.PacketsFloodProtector;
	...
	public ReceivablePacket<L2GameClient> handlePacket(ByteBuffer buf, L2GameClient client)
	{
		...
		switch(state)
		{
			...
			case IN_GAME:{
				...
				if(!com.l2j.netcore.Config.getInstance().LIST_ALLOWED_OFFLINE_OPCODES.contains(opcode)){
...
*/
						...
						if(!com.l2j.netcore.Config.getInstance().LIST_ALLOWED_OFFLINE_OPCODES2.contains(opcode2)){
	...
	private void printDebug(int opcode, ByteBuffer buf, GameClientState state, L2GameClient client)
	{
		...
		if (!com.l2j.netcore.Config.getInstance().PACKET_HANDLER_DEBUG)
			return;
