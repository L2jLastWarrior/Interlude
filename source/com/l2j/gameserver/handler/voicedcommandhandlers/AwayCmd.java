...
public class AwayCmd implements IVoicedCommandHandler
{
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.handler.IVoicedCommandHandler#useVoicedCommand(String, com.l2j.gameserver.model.L2PcInstance), String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.handler.IVoicedCommandHandler#getVoicedCommandList()
	 */
