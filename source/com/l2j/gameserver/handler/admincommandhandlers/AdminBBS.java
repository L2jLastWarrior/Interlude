...
import com.l2j.gameserver.communitybbs.Manager.AdminBBSManager;
...
public class AdminBBS implements IAdminCommandHandler
{
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.handler.IAdminCommandHandler#useAdminCommand
	 * (java.lang.String, com.l2j.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2j.gameserver.handler.IAdminCommandHandler#getAdminCommandList()
	 */
	@Override
