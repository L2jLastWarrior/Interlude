...
import static com.l2j.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE;
...
import com.l2j.gameserver.datatables.sql.TerritoryTable;
...
import com.l2j.gameserver.model.actor.instance.L2ChestInstance;
import com.l2j.gameserver.model.actor.instance.L2DoorInstance;
import com.l2j.gameserver.model.actor.instance.L2FestivalMonsterInstance;
import com.l2j.gameserver.model.actor.instance.L2FolkInstance;
import com.l2j.gameserver.model.actor.instance.L2FriendlyMobInstance;
...
import com.l2j.gameserver.model.actor.instance.L2PenaltyMonsterInstance;
import com.l2j.gameserver.model.actor.instance.L2PlayableInstance;
import com.l2j.gameserver.model.actor.instance.L2ProtectorInstance;
...
import com.l2j.gameserver.network.clientpackets.Say2;
...
public class L2AttackableAI extends L2CharacterAI implements Runnable
{
	 ...
	 */	
	@Override
	protected void onIntentionAttack(L2Character target) //Custom PvP PK Protect 
	{
		...
		else if(!(getActiveChar() instanceof L2GuardInstance)||getActiveChar() instanceof L2GuardInstance && getActiveChar().getNpcId()!=Config.KARMA_POLICE_ID)
		{
			super.onIntentionAttack(target);
		}
