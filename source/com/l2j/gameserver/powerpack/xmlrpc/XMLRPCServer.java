 ...
 */
package com.l2j.gameserver.powerpack.xmlrpc;
...
public class XMLRPCServer
{
	...
	private XMLRPCServer()
	{
		...
		try
		{
			_server = new WebServer(Config.XMLRPC_PORT, InetAddress.getByName(Config.XMLRPC_HOST));
			...
			try
			{
				L2Properties p = new L2Properties("config/Server_PowerPack/xmlrpc.service");
			...
			if(numServices > 0)
			{
				...
				_server.start();
				System.out.println("...Listen on " + Config.XMLRPC_HOST + ":" + Config.XMLRPC_PORT + ", " + numServices + " service(s) avaliable");
			}
			else
			{
