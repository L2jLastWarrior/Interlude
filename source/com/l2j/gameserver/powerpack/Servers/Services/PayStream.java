package com.l2j.gameserver.powerpack.Servers.Services;
...
import com.l2j.gameserver.powerpack.L2Utils;
import com.l2j.gameserver.util.sql.SQLQuery;
...
public class PayStream implements HttpHandler
{
	...
	{
		// Parse the config, which lies in the config / powerpack / webservices / paystream.properties
		L2Properties p = new L2Properties("./config/Server_PowerPack/webservices/paystream.properties");
