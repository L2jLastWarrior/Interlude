...
public class GameServerRegister
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		System.out.println("Welcome to L2jLastWarrior GameServer Regitering");
			...
			else
			{
				try
				{
					...
					else
					{
						...
						System.out.println("Put this file in the ./config/Server_Loader/ folder of your gameserver.");
						return;
					}
				}
