...
import com.l2j.gameserver.network.serverpackets.GameGuardQuery;
...
public class nProtect
{
	...
	private nProtect()
	{
		...
		try
		{
			clazz = Class.forName("com.l2j.protection.main");
		...
		{
			if(Config.DEBUG)
				_log.warning("nProtect System will be not loaded due to ClassNotFoundException of 'com.l2j.protection.main' class" );
		}
